...
form {
  ...
  grid-template-areas: "a a a bl b b b" ". . . xl x x x" "d d d d d d d";
  padding: 3rem 8rem;
  row-gap: 2rem;
    ...
    .input {
      ...
      .select-box {
        ...
        &:after {
          ...
          background-image: url(data:image/svg+xml;base64,);
          width: 1.5rem;
          height: 1rem;
